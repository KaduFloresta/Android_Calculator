...
# Android_Calculator - Java
Crie um programa em Android que simule uma calculadora. Sua aplicação deve conter dois campos EditText para os operandos, um TextView para o resultado e quatro campos Button para os operadores (+, -, * e /).
...
Incremente o programa acima. Se o resultado for maior que 100, um smile feliz deverá ser exibido. Caso contrário, um smile triste será mostrado.

Disponibilizar o projeto no GitHub e enviar o link de acesso.

- [X] Criar interface simples.
- [X] EditText p/ operandos.
- [X] TextView p/ resultado.
- [X] Botões p/ operadores.
- [X] Usar parseFloat.
- [X] Usar parseInt.
- [ ] Resultado > 100 = Smile Feliz.
